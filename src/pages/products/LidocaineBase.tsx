    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/10 via-secondary/5 to-background  mt-[80px] py-[80px] ">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground">Lidocaine Base</h1>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">
                  Lidocaine Base API for Pharmaceutical Formulations
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  We are a leading <strong>manufacturer and global supplier of Lidocaine Base API</strong>, catering to pharmaceutical 
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-3">What is Lidocaine Base?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Lidocaine Base is a local anesthetic and antiarrhythmic drug used to numb tissue in a specific area and to treat 
                  ventricular arrhythmias. It works by blocking sodium channels, which prevents the initiation and conduction of 
                  nerve impulses, thereby producing local anesthesia.
                </p>
              </div>

              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Lidocaine Base Specifications</h3>
                <Card className="overflow-hidden">
                  <Table>
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">CAS Number</TableCell>
                        <TableCell>137-58-6</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Molecular Formula</TableCell>
                        <TableCell>C14H22N2O</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Therapeutic Use</TableCell>
                        <TableCell>Local Anesthesia, Cardiac Arrhythmias</TableCell>
                      </TableRow>
                      <TableRow>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Why Choose Our Lidocaine Base API</h3>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Applications of Lidocaine Base API</h3>
                <p className="text-muted-foreground mb-3">Lidocaine Base API is widely used in:</p>
                <div className="space-y-3">
                  {[
                    'Topical Creams & Gels – For local anesthetic effects',
                    'Patches & Transdermal Systems – For chronic pain management',
                    'Dental Formulations – For oral anesthesia',
                    'Dermatological Products – For skin numbing applications'
                  ].map((app, index) => (
                    <div key={index} className="flex items-start gap-3">
              ...
              <Card className="p-6 sticky top-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">137-58-6</p>
                  </div>
                  <div>
