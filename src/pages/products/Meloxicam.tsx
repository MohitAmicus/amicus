    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/10 via-secondary/5 to-background mt-[80px] py-[80px]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground">Meloxicam</h1>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">
                  Meloxicam API for Pharmaceutical Formulations
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  We are a leading <strong>manufacturer and global supplier of Meloxicam API</strong>, catering to pharmaceutical 
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-3">What is Meloxicam?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Meloxicam is a nonsteroidal anti-inflammatory drug (NSAID) used to treat pain and inflammation in rheumatic diseases 
                  and osteoarthritis. It works by reducing hormones that cause inflammation and pain in the body. Meloxicam is known 
                  for its long duration of action, allowing once-daily dosing.
                </p>
              </div>

              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Meloxicam Specifications</h3>
                <Card className="overflow-hidden">
                  <Table>
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">CAS Number</TableCell>
                        <TableCell>71125-38-7</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Molecular Formula</TableCell>
                        <TableCell>C14H13N3O4S2</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Therapeutic Use</TableCell>
                        <TableCell>Osteoarthritis, Rheumatoid Arthritis, Pain Relief</TableCell>
                      </TableRow>
                      <TableRow>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Why Choose Our Meloxicam API</h3>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Applications of Meloxicam API</h3>
                <p className="text-muted-foreground mb-3">Meloxicam API is widely used in:</p>
                <div className="space-y-3">
                  {[
                    'Oral Tablets – For arthritis and pain management',
                    'Oral Suspensions – For pediatric applications',
                    'Injectable Solutions – For acute pain management',
                    'Combination Formulations – With other analgesics'
                  ].map((app, index) => (
                    <div key={index} className="flex items-start gap-3">
              ...
              <Card className="p-6 sticky top-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">71125-38-7</p>
                  </div>
                  <div>
