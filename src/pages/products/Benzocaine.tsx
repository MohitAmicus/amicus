    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/10 via-secondary/5 to-background  mt-[80px] py-[80px]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground">Benzocaine</h1>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">
                  Benzocaine API for Pharmaceutical Formulations
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  We are a leading <strong>manufacturer and global supplier of Benzocaine API</strong>, catering to pharmaceutical 
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-3">What is Benzocaine?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Benzocaine is a local anesthetic commonly used to reduce pain or discomfort caused by minor skin irritations, 
                  sore throat, sunburn, teething pain, vaginal or rectal irritation, and hemorrhoids. It works by blocking nerve 
                  signals in the body, providing temporary relief from pain and discomfort.
                </p>
              </div>

              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Benzocaine Specifications</h3>
                <Card className="overflow-hidden">
                  <Table>
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">CAS Number</TableCell>
                        <TableCell>94-09-7</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Molecular Formula</TableCell>
                        <TableCell>C9H11NO2</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Therapeutic Use</TableCell>
                        <TableCell>Local Anesthetic, Pain Relief</TableCell>
                      </TableRow>
                      <TableRow>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Why Choose Our Benzocaine API</h3>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Applications of Benzocaine API</h3>
                <p className="text-muted-foreground mb-3">Benzocaine API is widely used in:</p>
                <div className="space-y-3">
                  {[
                    'Topical Creams & Ointments – For skin irritations and minor burns',
                    'Throat Lozenges & Sprays – For sore throat relief',
                    'Dental Products – For teething and oral pain relief',
                    'OTC Pain Relief Products – For hemorrhoids and rectal discomfort'
                  ].map((app, index) => (
                    <div key={index} className="flex items-start gap-3">
              ...
              <Card className="p-6 sticky top-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">94-09-7</p>
                  </div>
                  <div>
