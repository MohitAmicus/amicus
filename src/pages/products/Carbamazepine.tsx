    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/10 via-secondary/5 to-background  mt-[80px] py-[80px]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground">Carbamazepine</h1>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-3xl font-display font-bold text-foreground mb-4">
                  Carbamazepine API for Pharmaceutical Formulations
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  We are a leading <strong>manufacturer and global supplier of Carbamazepine API</strong>, catering to pharmaceutical 
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-3">What is Carbamazepine?</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Carbamazepine is an anticonvulsant and mood-stabilizing drug used primarily in the treatment of epilepsy and 
                  bipolar disorder. It is also used to treat trigeminal neuralgia and other neuropathic pain conditions. 
                  The medication works by reducing the spread of seizure activity in the brain and restoring normal nerve activity.
                </p>
              </div>

              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Carbamazepine Specifications</h3>
                <Card className="overflow-hidden">
                  <Table>
                    <TableBody>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">CAS Number</TableCell>
                        <TableCell>298-46-4</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Molecular Formula</TableCell>
                        <TableCell>C15H12N2O</TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell className="font-semibold bg-muted/50">Therapeutic Use</TableCell>
                        <TableCell>Epilepsy, Bipolar Disorder, Neuropathic Pain</TableCell>
                      </TableRow>
                      <TableRow>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Why Choose Our Carbamazepine API</h3>
              ...
              <div>
                <h3 className="text-2xl font-display font-semibold text-foreground mb-4">Applications of Carbamazepine API</h3>
                <p className="text-muted-foreground mb-3">Carbamazepine API is widely used in:</p>
                <div className="space-y-3">
                  {[
                    'Tablets & Extended-Release Formulations – For epilepsy management',
                    'Oral Suspensions – For pediatric use',
                    'Chewable Tablets – For ease of administration',
                    'Combination Therapies – With other antiepileptic drugs'
                  ].map((app, index) => (
                    <div key={index} className="flex items-start gap-3">
              ...
              <Card className="p-6 sticky top-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">298-46-4</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">Therapeutic Category</p>
                    <p className="font-medium text-foreground">Neurological</p>
                  </div>
                </div>
